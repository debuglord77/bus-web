...
function Bottomhalf(){
    ...
    return(
        <div className="fixed bottom-0 left-0 w-full min-h-[60vh] bg-white rounded-t-[36px] flex justify-center pt-3 shadow-xl z-50">
            ...
            {/* box */}
            <div className="absolute w-[95%] h-[30%] bg-[#f3bc61] top-55 border-none border-black rounded-2xl shadow-xl/20"></div>
